          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose-premium mt-10 space-y-8 text-ink-700">
              ...
              <section>
                ...
                <p className="mt-3 leading-relaxed">
                  We accept payments via UPI, credit cards, debit cards, and Cash on Delivery (COD). Online payments are processed securely through Cashfree. Cash on Delivery is available for select pin codes and may involve an additional verification step.
                </p>
                <p className="mt-3 leading-relaxed">
