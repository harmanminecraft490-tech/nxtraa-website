          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose-premium mt-10 space-y-8 text-ink-700">
              ...
              <section>
                ...
                <p className="mt-2 leading-relaxed">
                  When you place an order, we collect your shipping address, phone number, order details, and payment information. Payment details are processed securely through Cashfree and are never stored on our servers.
                </p>

                <h3 className="mt-4 text-lg font-bold text-ink-950">Payment Information</h3>
                <p className="mt-2 leading-relaxed">
                  All payment transactions are processed through Cashfree, a PCI DSS compliant payment gateway. We do not store your credit card numbers, debit card numbers, UPI IDs, or any other payment credentials on our servers.
                </p>
              </section>
